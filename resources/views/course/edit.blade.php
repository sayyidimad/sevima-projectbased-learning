...
@section('content')
    @include('partials._breadcrumb', ['firstText' => 'Pelajaran /', 'secondText' => 'Edit Pelajaran'])
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="date" class="form-control" name="start_date"
                                    value="{{ $course->start_date }}" id="basic-icon-default-start-date" />
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="date" class="form-control" name="end_date"
                                    value="{{ $course->end_date }}" id="basic-icon-default-end-date" />
                            </div>

...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-6 offset-xl-3">
            <form action="{{ route('event.store', $course) }}" method="post">
                @csrf
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="assignment" rows="3">{{ old('assignment') }}</textarea>
